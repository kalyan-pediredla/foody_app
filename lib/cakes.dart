...
class softdrinks extends StatefulWidget {
  ...
  @override
  State<softdrinks> createState() => _softdrinksState();
}
...
class birthday_cakes extends StatefulWidget {
  const birthday_cakes({super.key});

  @override
  State<birthday_cakes> createState() => _birthday_cakesState();
}

class _birthday_cakesState extends State<birthday_cakes> {

  List<Contact> li=<Contact>[
    Contact(imgPath: "https://bkmedia.bakingo.com/squ-choco-black-forest-cake-cake888blac-A.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Sinful Black Forest',price: 399),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-black-forest-cake0001chbl-A_1.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Black Forest Cake',price: 499),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-pineapple-cake0022pifr-AA_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Pineapple Cream Cake',price: 299),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-snicker-chocolate-cake0028choc-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Snicker Fuse Chocolate',price: 599),
    Contact(imgPath: "https://bkmedia.bakingo.com/chocolicious-marble-cake-cake2615choc-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Chocolate Marble Cake',price: 399),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-vanilla-fruit-cake-cake894frui-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Fruit Funfetti Vanilla Cake',price: 499),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-lip-smacking-chocolate-truffle-cake-cake2161choc-A_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Lip-smacking Chocolate..',price: 559),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-kitkat-cake-n-gems-topping-cake1786choc-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Kitkat Cake N Gems To..',price: 499),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-blueberry-cake-1-cake889blue-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Blueberry Cake',price: 679),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-chocolate-butterscotch-cake0007chbu-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Butterscotch Chocolate C..',price: 309),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-red-velvet-fruit-cake0037refr-A_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Red Velvet Fruit Layer Cake',price: 250),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-chocolaty-creamy-round-cake-cake2160choc-A_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Chocolaty Creamy Round',price: 399),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-german-black-forest-cake0015chbl-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Black Forest Cherry Cake',price: 399),
    Contact(imgPath: "https://bkmedia.bakingo.com/squ-funfetti-rainbow-tower-cake0397exot-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Rainbow Sprinkles Cake',price: 399),
    Contact(imgPath: "https://bkmedia.bakingo.com/chocolate-chip-cake0008choc-AAA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Choco Chip Truffle Cake',price: 599),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-red-velvet-cake-with-choco-sticks-cake1630redv-A_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Red Velvet Cake With Ch...',price: 349),
    Contact(imgPath: "https://bkmedia.bakingo.com/caramel-cake-cake1605cara-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Caramel Cake',price: 340),
    Contact(imgPath: "https://bkmedia.bakingo.com/chocolate-truffle-fruit-cake-cake0756chfr-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Chocolate Truffle Fruit C..',price: 354),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-oreo-chocolate-cake0021chex-AA.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Chocolate Oreo Cream C..',price: 330),
    Contact(imgPath: "https://bkmedia.bakingo.com/sq-semi-naked-blackforest-cake-cake1640blac-A_0.jpg?tr=w-320,h-320,dpr-1.5,q-70", name:'Scrumptious Black Forest',price: 499),
